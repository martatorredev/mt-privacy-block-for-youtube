...
This plugin can be installed directly from your WordPress admin panel.
...
= 1.0.0 =
Initial release. No actions required for upgrade.
...
For support or inquiries, visit: [https://martatorre.dev](https://martatorre.dev)
